...
const loginUser = (email, password) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    // Create tokens
    const accessToken = (0, exports.createJwtToken)(userId.toString()); // Ensure _id is a string
    const refreshToken = (0, exports.createRefreshToken)(userId.toString()); // Ensure _id is a string
